...
import com.example.easychat.AdapterClasses.ChatsAdapter
import com.example.easychat.Fragments.APIService
import com.example.easychat.ModelClasses.Chat
import com.example.easychat.ModelClasses.Users
import com.example.easychat.Notifications.*
...
//            startActivity(intent)
        ...
        send_message_btn.setOnClickListener {
            ...
            if (message == "") {
                Toast.makeText(this@MessageChatActivity, "Please write a message, first...", Toast.LENGTH_LONG)
            }
            else {
    ...
    private fun sendNotification(receiverId: String?, userName: String?, message: String)
    {
        ...
        query.addValueEventListener(object: ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                for(dataSnapshopt in p0.children)
                {
                    val token: Token? = dataSnapshopt.getValue(Token:: class.java)
                        ...
                        .enqueue(object: Callback<MyResponse>{
                            override fun onResponse(
                                ...
                                if(response.code() == 200)
                                {
                                    ...
                                    {
                                        Toast.makeText(this@MessageChatActivity, "Failed, Nothing Happend", Toast.LENGTH_SHORT)
                                    }
                                }
                            }
