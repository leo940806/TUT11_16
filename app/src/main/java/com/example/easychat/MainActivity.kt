...
import com.example.easychat.Fragments.SearchFragment
import com.example.easychat.Fragments.SettingsFragment
...
//        tabLayout.setupWithViewPager(viewPager)
        val ref = FirebaseDatabase.getInstance().reference.child("ChatList").child("Chats")
